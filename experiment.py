...
def plot_stuff(deltas_value, deltas_iteration):
    ...
    # plt.tick_params(labelbottom=False)
    # Add title
    plt.title("Policy Iteration", loc="left", fontsize=12, fontweight=0, color=palette(2))
    ...
    # plt.tick_params(labelleft=False)
    # Add title
    plt.title("Policy Iteration", loc="left", fontsize=12, fontweight=0, color=palette(3))
